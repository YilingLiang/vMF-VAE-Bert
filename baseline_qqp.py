...
from models import Baseline_Embeddings, Baseline_LSTM, Baseline_LSTMQQP
...
baseline_model = Baseline_LSTMQQP(100, 300, maxlen=max_len, gpu=False)
model_type = 'lstm'
baseline_model.load_state_dict(torch.load("./lstmlast_0.75QQP.pt"))#  , map_location=torch.device('cpu')
