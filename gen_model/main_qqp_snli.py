...
# config.gpu_options.per_process_gpu_memory_fraction = 0.9 # 显存占用比例上限为 0.3
# config.gpu_options.allow_growth=True # 显存自动调用
...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        # 保存权重 
        model.save_weights('./qqp_snli.weights') 
        # 演示效果 
        just_show()
...
if __name__ == '__main__':
    ...
    model.load_weights('./qqp_snli_loss_0.33.weights')
