...
from dataset_utils import convert_examples_to_features, load_and_cache_examples_qqp, QQPProcessor
...
# model_name_or_path = './bert_qqp_uncased/checkpoint-'
epochs = 3
num_labels = 2
...
def evaluate_model():
    eval_dataset = load_and_cache_examples_qqp(task_name, tokenizer, evaluate=True)
...
if train_mode == True:
    ...
    for _ in train_iterator:
        ...
        train_dataset = load_and_cache_examples_qqp(task_name, tokenizer, evaluate=False)
