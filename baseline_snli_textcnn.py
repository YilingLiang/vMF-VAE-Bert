from models import Baseline_Embeddings, Baseline_LSTM, TextCNN
...
baseline_model = TextCNN(100, 300, class_num=3, maxlen=max_len, gpu=False)
model_type = 'textcnn'
baseline_model.load_state_dict(torch.load("./textcnnlast_0.63.pt"))#  , map_location=torch.device('cpu')
